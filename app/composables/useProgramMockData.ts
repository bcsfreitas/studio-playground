    ...
    curriculum: [
      {
        ...
        items: [
          ...
          { id: 'item-16x16-character', type: 'task', title: 'Draw a 16x16 character sprite', xp: 150 },
          { id: 'item-walk-cycle', type: 'task', title: 'Build a 4-frame walk cycle', xp: 200 }
        ]
      },
      {
        ...
        items: [
          { id: 'item-palette-libraries', type: 'resource', title: 'Recommended palette libraries', xp: 0 },
          { id: 'item-recolor-sprite', type: 'task', title: 'Recolor your sprite with an 8-color palette', xp: 150 },
          { id: 'item-color-survey', type: 'survey', title: 'How comfortable are you with color theory?', xp: 0 }
        ]
      },
      {
        ...
        title: 'Export & Reuse',
        items: [
          { id: 'item-export-godot', type: 'task', title: 'Export a sprite sheet for Godot', xp: 150 },
          { id: 'item-idle-run-blend', type: 'task', title: 'Animate an idle-to-run blend', xp: 250 }
        ]
      }
    ]
  },
    ...
    curriculum: [
      {
        ...
        items: [
          { id: 'item-project-structure', type: 'topic', title: 'Godot project structure', xp: 0 },
          { id: 'item-player-movement', type: 'task', title: 'Wire up player movement in Godot', xp: 150 },
          { id: 'item-win-lose', type: 'task', title: 'Add a win/lose condition', xp: 250 }
        ]
      },
      {
        ...
        items: [
          { id: 'item-save-load', type: 'task', title: 'Implement a save/load system', xp: 300 },
          { id: 'item-juice', type: 'task', title: 'Add sound effects and juice', xp: 250 }
        ]
      },
      {
        ...
        title: 'Team Workflow',
        items: [
          { id: 'item-git-cheatsheet', type: 'resource', title: 'Git basics cheat sheet', xp: 0 },
          { id: 'item-shared-repo', type: 'task', title: 'Set up a shared GitHub repo', xp: 200 },
          { id: 'item-pull-request', type: 'task', title: "Review a teammate's pull request", xp: 150 }
        ]
      },
      {
        id: 'module-ship-it',
        title: 'Ship It',
        items: [
          { id: 'item-publish-build', type: 'task', title: 'Publish a build to the Endstar library', xp: 100 },
          { id: 'item-ship-survey', type: 'survey', title: 'Rate your experience shipping a build', xp: 0 }
        ]
      }
    ]
  },
    ...
    curriculum: [
      {
        ...
        items: [
          { id: 'item-pacing-principles', type: 'topic', title: 'Principles of level pacing', xp: 0 },
          { id: 'item-blockout', type: 'task', title: 'Block out a level using primitive shapes', xp: 150 },
          { id: 'item-pacing-playtest', type: 'task', title: 'Playtest and note pacing issues', xp: 200 }
        ]
      },
      {
        ...
        items: [
          { id: 'item-teach-mechanic', type: 'task', title: 'Design a challenge teaching a new mechanic', xp: 300 },
          { id: 'item-difficulty-curve', type: 'task', title: 'Place enemies to create a difficulty curve', xp: 200 }
        ]
      },
      {
        ...
        title: 'Polish & Ship',
        items: [
          { id: 'item-lighting-pack', type: 'resource', title: 'Lighting reference pack', xp: 0 },
          { id: 'item-lighting-dressing', type: 'task', title: 'Add lighting and set dressing', xp: 200 }
        ]
      }
    ]
  },
    ...
    curriculum: [
      {
        ...
        items: [
          { id: 'item-rig-hierarchy', type: 'topic', title: 'Rig hierarchy overview', xp: 0 },
          { id: 'item-base-skeleton', type: 'task', title: 'Build a base skeleton for a quadruped', xp: 200 }
        ]
      },
      {
        ...
        items: [
          { id: 'item-weight-paint', type: 'task', title: 'Weight paint a walk-ready mesh', xp: 250 },
          { id: 'item-fix-pinching', type: 'task', title: 'Fix pinching at major joints', xp: 200 }
        ]
      },
      {
        id: 'module-animate',
        title: 'Animate',
        items: [
          { id: 'item-walk-cycle-block', type: 'task', title: 'Block a walk cycle using the rig', xp: 150 },
          { id: 'item-rig-survey', type: 'survey', title: 'How confident do you feel rigging a biped next?', xp: 0 }
        ]
      }
    ]
  }
