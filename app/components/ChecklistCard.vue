...
const { t } = useI18n()
const { items, toggle, completedCount, totalCount, isComplete } = useOnboardingChecklist(props.flowId, props.contextId)
    ...
    <template #header>
      <div class="flex items-center gap-3.5">
        ...
        <div>
          ...
          <div v-else class="inline-flex items-center gap-1 mt-0.5 text-xs font-semibold text-success">
